        ...
        return ( 
            <div className={ css(styles.aFrame) }>
                <a-scene fog="type: exponential; color: #fff;" vr-mode-ui="enabled: false" scroll-listener="" cursor="rayOrigin: mouse">
                    ...
                    <a-entity id="level1-middle" position="0 -10 -25" rotation="0 0 0">
                    ...
                    <a-entity id="level1" position="0 -10 -35" rotation="0 0 0">
                        ...
                        <cloud-smoke position="0 -1 -11" smoke-particles="size:10; minx:-40; maxx:40; miny:-1; maxy:1; minz:-1; maxz:-5;"></cloud-smoke> 
                    </a-entity>

                    <a-plane id="level-2-filter" position="0 -15 -60" rotation="0 0 0" height="100" width="100" color="#fff"></a-plane>

                    <a-entity id="level2" position="-0.65 -15 -70" rotation="0 0 0">
                        <a-plane id="divisor" position="0 1.5 -4" rotation="0 0 0" width="0.01" height="3" color="#9E9E9E"></a-plane>
                        <a-image id="studioImg"src="#logoStudio" position="-3 2.5 -4" width="1" height="1.48" parallax="rangex:0.05; rangey:0.05; speed:0.1"></a-image>
                        <a-image id="broadcastImg" src="#logoBroadcast" position="3 2.5 -4" width="1" height="1.48" parallax="rangex:0.05; rangey:0.05; speed:0.1"></a-image>
